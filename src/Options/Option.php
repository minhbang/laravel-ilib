...
/**
 * Class Option
 * Session option, sử dụng cho các thiết lập hiển thị
 * Todo: lưu / phục hồi các thiết lập sử sụng cookie
 *
...
abstract class Option
{
     ...
     * @param array $default
     */
    public function __construct($group, $default = null)
    {
        $this->name = "ilib.{$group}";
        $default = $default ?: config("ilib.options.$group", []);
